                ...
                <div class="p-10 pb-6">
                    ...
                    <div class="flex flex-wrap mb-2 -mx-3">
                        <div class="w-full px-3 mb-2 md:w-1/2 md:mb-0">
                            ...
                            <label
                                class="block w-full px-4 py-3 mb-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white">{{ $tender->date }}</label>
                        </div>
                        <div class="w-full px-3 md:w-1/2">
                            <label class="block mb-2 text-xs font-bold tracking-wide text-gray-700 capitalize"
