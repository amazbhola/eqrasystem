    ...
    <div id="sidebar" class="fixed left-0 top-0 w-72 h-full bg-gray-800 shadow-md z-10 flex flex-col" >
        ...
        <div class="flex flex-col justify-between flex-grow">
            <div class="py-5">
                ...
                <a class="flex items-center border-l-4 hover:border-blue-600 px-4 py-3 mb-1 text-white hover:bg-gray-900 border-transparent transition" href="{{route('tender.index')}}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 13h6m-3-3v6m5 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                      </svg>
                      Tender list
